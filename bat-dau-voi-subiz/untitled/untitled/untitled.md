...
Để tạo rule mới, bạn [đăng nhập tài khoản](https://app.subiz.com/login) và vào phần **Cài đặt &gt; Tài khoản &gt; Tin nhắn &gt; Rule &gt; Tạo Rule mới**![](http://docv4.subiz.com/wp-content/uploads/2018/01/create-rule.png)
...
#### **1. Phân phối tới các Agent hoặc nhóm Agent** {#1-phan-phoi-toi-cac-agent-hoac-nhom-agent}
...
### DANH SÁCH CÁC ĐIỀU KIỆN TRONG RULE {#danh-sach-cac-dieu-kien-trong-rule}
